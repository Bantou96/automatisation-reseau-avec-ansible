...
- [cisco-playbook](https://github.com/Bantou96/automatisation-reseau-avec-ansible/tree/master/cisco-playbook) : contient des exemples de playbooks que vous serez appelé à lancer sur vos équipements cisco notamment les switches et les routeurs. 
