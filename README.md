...
- [output](https://github.com/Bantou96/automatisation-reseau-avec-ansible/tree/master/output) --> contient le résultat de la commande show version avec utilisant du parser  
